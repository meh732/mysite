...
async function startServer() {
  ...
  // Port configuration: AI Studio strictly routes ingress traffic on port 3000.
  // In a custom VPS/production deployment, a local .env file is generated by the installer.
  // We check for the presence of .env to respect custom ports on their server, otherwise defaulting to 3000.
  let PORT = 3000;
